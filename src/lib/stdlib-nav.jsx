    ...
    namespaces: [
      ...
      },
      {
        ...
        methods: [
          ...
          { label: "fromI32", slug: "fromI32" },
          { label: "fromI64", slug: "fromI64" },
          { label: "fromF32", slug: "fromF32" },
          { label: "fromF64", slug: "fromF64" },
          { label: "c", slug: "c" },
          { label: "strdup", slug: "strdup" },
          { label: "length", slug: "length" },
          { label: "isEmpty", slug: "isEmpty" },
          { label: "charAt", slug: "charAt" },
          { label: "equals", slug: "equals" },
          { label: "contains", slug: "contains" },
          { label: "startsWith", slug: "startsWith" },
          { label: "endsWith", slug: "endsWith" },
          { label: "indexOf", slug: "indexOf" },
          { label: "lastIndexOf", slug: "lastIndexOf" },
          { label: "toUpperCase", slug: "toUpperCase" },
          { label: "toLowerCase", slug: "toLowerCase" },
          { label: "trim", slug: "trim" },
          { label: "trimStart", slug: "trimStart" },
          { label: "trimEnd", slug: "trimEnd" },
          { label: "replace", slug: "replace" },
          { label: "substring", slug: "substring" },
          { label: "substring", slug: "substring" },
          { label: "repeat", slug: "repeat" },
          { label: "reverse", slug: "reverse" },
          { label: "toI32", slug: "toI32" },
          { label: "toI64", slug: "toI64" },
          { label: "toF32", slug: "toF32" },
          { label: "toF64", slug: "toF64" },
          { label: "format", slug: "format" },
          { label: "split", slug: "split" },
          { label: "join", slug: "join" },
          { label: "toString", slug: "toString" },
        ],
      },
      {
        label: "Thread",
