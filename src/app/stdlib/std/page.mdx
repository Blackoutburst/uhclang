...
namespace HashMap {
    struct It;
    void put(HashMap<K, V> map, K key, V value);
    V& get(HashMap<K, V> map, K key);
    V getOrDefault(HashMap<K, V> map, K key, V defaultValue);
    unsigned char remove(HashMap<K, V> map, K key);
    unsigned char containsKey(HashMap<K, V> map, K key);
    unsigned char containsValue(HashMap<K, V> map, V value);
    unsigned long long size(HashMap<K, V> map);
    unsigned char isEmpty(HashMap<K, V> map);
    void clear(HashMap<K, V> map);
    List::It<K> keys(HashMap<K, V> map);
    List::It<V> values(HashMap<K, V> map);
    void putAll(HashMap<K, V> map, HashMap<K, V> other);
    unsigned char putIfAbsent(HashMap<K, V> map, K key, V value);
    void forEach(HashMap<K, V> map, lambda block(K, V) -> void);
}
